...
```php
//...
use srag\RemovePluginDataConfirm\SrSearchPDBlock\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\SrSearchPDBlock\x\RepositoryObjectPluginUninstallTrait;
//...
