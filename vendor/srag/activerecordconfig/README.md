...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\SrSearchPDBlock\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\SrSearchPDBlock\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\SrSearchPDBlock\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
