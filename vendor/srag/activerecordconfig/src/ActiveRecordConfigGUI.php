...
namespace srag\ActiveRecordConfig\SrSearchPDBlock;

use ilPluginConfigGUI;
use ilUtil;
use srag\ActiveRecordConfig\SrSearchPDBlock\Exception\ActiveRecordConfigException;
use srag\DIC\SrSearchPDBlock\DICTrait;

/**
 * Class ActiveRecordConfigGUI
 *
 * @package    srag\ActiveRecordConfig\SrSearchPDBlock
 *
