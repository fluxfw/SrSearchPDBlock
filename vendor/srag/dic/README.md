...
```php
\srag\DIC\SrSearchPDBlock\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrSearchPDBlock\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\SrSearchPDBlock\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
